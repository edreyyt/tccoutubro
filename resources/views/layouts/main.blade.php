...
<footer class=" pt-60 bg-white">
  <div class="container px-4 mx-auto">
    <div class="flex flex-wrap text-left lg:text-left">
      ...
      <div class="w-1/2 px-4 lg:w-6/12">
        <div class="flex flex-wrap mb-6 items-top">
          ...
          <div class="w-full px-4 lg:w-4/12">
            ...
            <ul class="list-unstyled">
              <li>
                <a class="block pb-2 text-sm font-semibold text-gray-600 dark:text-gray-400" href="{{ url('/termos') }}">Termos &amp; Condições</a>
              </li>
              <li>
