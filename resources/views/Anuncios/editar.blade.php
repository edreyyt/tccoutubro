...
<header class=" pt-8 pb-6 bg-white ">
   ...
   <div id="event-create-container" class="col-md-6 offset-md-3 text-gray-400">
      <h2 class="text-gray-400">Página de edição do Anúncio! </h2>
      <form action="/post/{{$anuncio->id}}/edit" method="POST" enctype="multipart/form-data">
...
<body class="bg-white" >          
       ...
       <div class="form-group text-gray-400">
        ...
        <div class="form-group text-gray-400 bg-center">
           ...
           <img class="" src="/img/events/{{ $livros->image }} ">
        </div>  

        <div class="form-group text-gray-400 bg-center">
           <label for="title">Livro:</label>
           <input type="text" class="form-control" id="title" name="title" placeholder="Nome do Livro" value="{{ $livros->title }}">
        </div>
        ...
        <div class="form-group text-gray-400 ">
           <label for="title">Características:</label>
        ...
        <input type="submit" class="btn btn-primary text-black border-black" value="Criar Anúncio!">
</div>
</body>
</html>
@section('content')
